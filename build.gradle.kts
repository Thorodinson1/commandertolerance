...
subprojects {
    ...
    cloudstream {
        ...
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "https://github.com/Thorodinson1/commandertolerance")

        authors = listOf("Tolerance")
    }
    ...
    dependencies {
        ...
        implementation("com.github.consumet:consumet.ts:v1.5.0") // consumet api
