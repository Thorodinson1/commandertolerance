...
class MHDTVProvider : MainAPI() { // all providers must be an instance of MainAPI
    override var mainUrl = "https://mhdtvworld.tv"
    ...
    override suspend fun loadLinks(
        ...
        if (data.startsWith("https://mhdtvworld.tv/jwplayer/")) {
        ...
        } else if (data.startsWith("https://mhdtvworld.tv/delta") || data.startsWith("https://yuppstream.net.in/")) {
